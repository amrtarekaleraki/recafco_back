    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <h2 class="h5 page-title">{{ __('keywords.show_category') }}</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                      ...
                                      <p class="form-control">{{ $category->getTranslation('title','en') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                      ...
                                      <p class="form-control">{{ $category->getTranslation('title','ar') }}</p>
                                    </div>
                                </div>
